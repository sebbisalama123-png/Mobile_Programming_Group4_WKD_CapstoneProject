...
import com.ndejje.saccomobileapplication.viewmodel.ForgotPasswordStep
import com.ndejje.saccomobileapplication.viewmodel.ForgotPasswordViewModel
...
fun ForgotPasswordScreen(
    ...
    val viewModel = viewModel<ForgotPasswordViewModel>(
        factory = ForgotPasswordViewModel.factory(app.repository)
    )
    ...
    Scaffold(
        ...
        Column(
            ...
            if (uiState.step == ForgotPasswordStep.VERIFY_IDENTITY) {
                Text(
                    text = stringResource(R.string.forgot_step1_subtitle),
                ...
                OutlinedTextField(
                    ...
                    modifier = Modifier
                        .fillMaxWidth()
                        .padding(top = dimensionResource(R.dimen.spacingSmall))
                )

                OutlinedTextField(
                    value = uiState.idNumber,
                    onValueChange = viewModel::setIdNumber,
                ...
                Button(
                    onClick = viewModel::verifyIdentity,
                    enabled = uiState.isVerifyFormValid && !uiState.isLoading,
                    modifier = Modifier
                        .fillMaxWidth()
                ...
                Text(
                    text = stringResource(R.string.forgot_step2_subtitle),
                    style = MaterialTheme.typography.bodyMedium.copy(color = MediumGrey),
                    modifier = Modifier.padding(top = dimensionResource(R.dimen.spacingMedium))
                )
                ...
                Button(
                    ...
                    enabled = uiState.isResetFormValid && !uiState.isLoading,
                    modifier = Modifier
                        .fillMaxWidth()
                        .height(dimensionResource(R.dimen.buttonHeight))
                        .padding(top = dimensionResource(R.dimen.spacingLarge)),
